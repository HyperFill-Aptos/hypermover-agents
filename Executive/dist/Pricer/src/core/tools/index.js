import { z } from "zod";
export function registerTools(server, vaultClient) {
    server.registerTool("fetch_vault_balance", {
    ...
    server.registerTool("get_available_assets", {
    ...
    server.registerTool("get_user_share_balance", {
