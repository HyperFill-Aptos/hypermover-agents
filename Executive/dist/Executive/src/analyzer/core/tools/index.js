...
export function registerTools(server, marketManager) {
    ...
    server.registerTool("get_best_order", {
    ...
    server.registerTool("get_best_bid", {
        title: "Get Best Bid",
    ...
    server.registerTool("get_best_ask", {
        title: "Get Best Ask",
    ...
    server.registerTool("check_available_funds", {
    ...
    server.registerTool("get_settlement_health", {
    ...
    server.registerTool("format_symbol", {
    ...
    server.registerTool("parse_symbol", {
