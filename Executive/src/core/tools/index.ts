...
export function registerTools(server: McpServer, vaultExecutor: AptosVaultExecutor, botClient: MarketMakerBotClient) {

    server.registerTool(
        "move_from_vault_to_wallet",
        {
